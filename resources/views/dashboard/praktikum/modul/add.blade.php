  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12 mb-4 mb-xl-0">
            <div
              ...
              <div>
                <h3 class="font-weight-bold">Tambah Data Modul Praktikum</h3>
                <h6 class="font-weight-normal mb-0">Tambahkan data Modul Praktikum Anda di sini!</h6>
              </div>
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('dashboard.praktikum.modul.store') }}" method="POST" class="form-sample"
