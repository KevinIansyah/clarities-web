  ...
  <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12 mb-4 mb-xl-0">
            <div
              ...
              <div>
                <h3 class="font-weight-bold">Tambah Data Pelatihan</h3>
                <h6 class="font-weight-normal mb-0">Tambahkan data Pelatihan Anda di sini!</h6>
              </div>
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('dashboard.pages.pelatihan.store') }}" method="POST" class="form-sample"
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="hightight">Higlight</label>
                    <select class="form-control" id="highlight" name="highlight" required>
                      <option selected disabled>Pilih highlight</option>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="overview" name="overview" rows="5"
                      placeholder="Tulis overview singkat dari pelatihan"></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea id="editorPelatihan" name="content"></textarea>
                  </div>
                </div>
              </div>
...
@push('scripts')
  <script type="module">
    ...
    CKEDITOR.ClassicEditor.create(document.querySelector('#editorPelatihan'), {
      toolbar: {
        items: [
          'heading', '|',
