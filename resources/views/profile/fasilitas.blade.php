...
@section('title', 'Fasilitas - Clarities')
@section('meta-description',
  'Temukan berbagai fasilitas yang tersedia di Clarities Laboratorium Hukum UPN Veteran Jatim
  untuk mendukung penelitian dan pembelajaran di bidang hukum.')
      ...
      <div class="col-lg-8 mb-5 mb-lg-0 mx-auto">
        <nav class="d-flex justify-content-center w-100" aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-dots mb-1">
            ...
            <li class="breadcrumb-item active" aria-current="page">Faslilitas</li>
          </ol>
        </nav>

        <h2 class="font-weight-bold mb-3 mb-lg-4 text-center">Faslilitas Clarities</h2>
          ...
          @foreach ($fasilitas as $item)
            ...
            <a href="{{ asset('storage/filepond-image/' . $item->image) }}" data-fancybox="gallery"
              ...
              <img src="{{ asset('storage/filepond-image/' . $item->image) }}"
                class="w-100 h-auto object-fit-cover object-position-center rounded mb-3"
                alt="gambar fasilitas {{ $item->name }}">
            </a>
