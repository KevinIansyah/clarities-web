<footer class="bg-dark position-relative overflow-hidden pt-6">
  ...
  <div class="position-absolute top-0 end-0 mt-n3 me-n4">
    <img src="{{ asset('images/elements/decoration-pattern-2.svg') }}" style="opacity:0.05;" alt="dekorasi footer">
  </div>
  ...
  <div class="container position-relative mt-5">
    <div class="row justify-content-between">
      ...
      <div class="col-lg-3">
        <a href="/" class="d-flex align-items-center gap-2 text-decoration-none">
          <img src="{{ asset('images/logo.png') }}" alt="logo" style="width: 3rem; height: 3rem;">
          <h5 class="text-white mb-0">CLARITIES</h5>
        </a>

        <p class="mt-4 mb-4 mb-sm-5 me-lg-4 text-white">Clarities merupakan Laboratorium Hukum yang dimiliki oleh
          Fakultas Hukum, UPN Veteran Jawa Timur.</p>
      </div>

      <div class="col-lg-9">
        <div class="row g-4">
          <div class="col-md-3">
            <h6 class="mb-2 mb-md-4 text-white font-weight-semibold">Profil</h6>
            <ul class="nav flex-column">
              <li class="nav-item"><a class="nav-link pt-0" href="{{ route('profil.tujuan') }}">Tujuan</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('profil.visi-misi') }}">Visi Misi</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('profil.struktur-organisasi') }}">Struktur
                  Organisasi</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('profil.unit-bagian') }}">Unit Bagian</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('profil.pengelola') }}">Pengelola</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('profil.fasilitas') }}">Fasilitas</a></li>
            </ul>
          </div>

          <div class="col-md-3">
            <h6 class="mb-2 mb-md-4 text-white font-weight-semibold">Praktikum</h6>
            <ul class="nav flex-column">
              <li class="nav-item"><a class="nav-link pt-0"
                  href="{{ route('praktikum.modul-praktikum.index') }}">Modul</a></li>
              <li class="nav-item"><a class="nav-link"
                  href="c{{ route('praktikum.jadwal-praktikum.index') }}">Jadwal</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('praktikum.kurikulum-lab.index') }}">Kurikulum
                  Lab</a></li>
              <li class="nav-item"><a class="nav-link"
                  href="{{ route('praktikum.peminjaman-ruang-lab.index') }}">Peminjaman Lab</a></li>
            </ul>
          </div>

          <div class="col-md-3">
            <h6 class="mb-2 mb-md-4 text-white font-weight-semibold">Informasi</h6>
            <ul class="nav flex-column">
              <li class="nav-item"><a class="nav-link pt-0" href="{{ route('informasi.sop') }}">SOP</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('informasi.kerja-sama') }}">Kerja Sama</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('informasi.pelatihan') }}">Pelatihan</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ route('informasi.kalender-akademik') }}">Kalender</a>
              </li>
            </ul>
          </div>

          <div class="col-md-3">
            <h6 class="mb-2 mb-md-4 text-white font-weight-semibold">Komunitas</h6>
            <ul class="nav flex-column mb-4">
              <li class="nav-item"><a class="nav-link pt-0" href="https://www.upnjatim.ac.id/">Fakultas Hukum</a></li>
              <li class="nav-item"><a class="nav-link" href="https://fh.upnjatim.ac.id/">UPN Veteran Jatim</a></li>
            </ul>

            <h6 class="mb-2 mb-md-4 text-white font-weight-semibold">Alamat</h6>
            <ul class="nav flex-column mb-4">
              <li class="nav-item">
                <p class="nav-link">Jl. Rungkut Madya No.1, Gn. Anyar, Kec. Gn. Anyar, Surabaya, Jawa Timur 60294</p>
              </li>
            </ul>

            <h6 class="mb-2 mb-md-4 text-white font-weight-semibold">Pengunjung</h6>
            <ul class="nav flex-column mb-4">
              <li class="nav-item">
                <p class="nav-link"><i class="fa-duotone fa-solid fa-eye pe-2"></i>{{ $pageView->views }}</p>
              </li>
            </ul>
          </div>
        </div>
    ...
    <hr class="mt-4 mb-0 bg-white">

    <div class="d-flex justify-content-center align-items-center text-center py-4">
      <p class="mb-0 text-white"> Copyrights ©2024 Clarities. All Rights Reserved.</p>
    </div>
  </div>
</footer>
